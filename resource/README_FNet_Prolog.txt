...
.  Note that all data have been extracted from the version of FrameNet 1.4 distributed during the SemEval task, which is officially under development.  Some information have been added w.r.t the last Berkeley FN release (v. 1.3).  
...
title     = {VENSES++: Adapting a deep semantic processing system to the identification of null instantiations},  booktitle = {Proceedings of the 5th International Workshop on Semantic Evaluation},   
month     = {July},   
year      = {2010},   
